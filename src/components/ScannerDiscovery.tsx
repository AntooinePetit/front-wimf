  ...
  return (
    <section id="scanner-discovery" className="container">
      ...
      <div>
        ...
        <article>
          <p>
            Il te reste des ingrédients au frigo mais tu ne sais pas quoi
            cuisiner ?
          </p>
          <p>
          ...
          <p>
            Aucune ne te convient ? Pas de souci : notre intelligence
            artificielle peut t’en créer une sur mesure. Et si la recette te
            plaît, partage-la avec nous pour qu’elle ait une chance de rejoindre
            notre catalogue !
          </p>

          {!isMobile && (
            <p>Exclusivement disponible sur mobile et tablette !</p>
          )}
        </article>
      </div>
