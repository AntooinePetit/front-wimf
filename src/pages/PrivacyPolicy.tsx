  ...
  return (
    <main className="legal-main">
      ...
      <section>
        ...
        <p>
          En cas d'inactivité prolongée, les comptes et leurs données associées
          sont supprimés ou anonymisés après 2 ans d'inactivité.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>Base de données</strong> : Neon, Inc., 2128 Sand Hill Road,
            Menlo Park, CA 94025, États-Unis
          </li>
        </ul>
        <p>
          Les mots de passe sont chiffrés et les accès aux bases de données sont
          protégés.
        </p>
        ...
        <ul>
          ...
          <li>
            Droit à la portabilité : vous pouvez demander à recevoir vos données
            dans un format structuré et lisible, ou les transférer vers un autre
            service
          </li>
        </ul>
        <p>
          Pour exercer ces droits, contactez Petit Antoine à l'adresse suivante
        ...
        <p>
          ...
          l'évolution du site ou de la législation.
        </p>
        <p>
