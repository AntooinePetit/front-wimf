    ...
    <main className="legal-main">
      ...
      <section>
        ...
        <p>
          ...
          incluant un outil d'analyse du contenu du réfrigérateur permettant de
          trouver des recettes adaptées aux ingrédients disponibles.
        </p>
        <p>
          Le service est accessible depuis un navigateur web, sur ordinateur ou
          mobile.
        </p>

        <h2>2. Accès au service</h2>
        <p>
          <strong>Accès libre :</strong> Certaines fonctionnalités du site sont
          accessibles sans création de compte.
        </p>
        ...
        <p>
          Tout manquement peut entraîner la suppression du contenu publié et la
          résiliation du compte conformément à la section Résiliation.
        </p>
        ...
        <p>
          Les recettes publiées sur ce site sont protégées par le droit d'auteur
          dans leur forme et présentation (texte, mise en page, photos).
        </p>
        ...
        <p>Pour plus de détails, consultez la Politique de confidentialité.</p>
        ...
        <h2>8. Résiliation</h2>
        <p>
          L'éditeur se réserve le droit de mettre fin à l'accès au service ou de
          supprimer un compte en cas d'agissements contraires aux présentes CGU,
          notamment en cas de publication de contenus illicites ou offensants.
        </p>
        <p>
        ...
        <p>
          ...
          responsable lors de la manipulation d'ustensiles ou de la réalisation
          de recettes.
        </p>
      </section>
