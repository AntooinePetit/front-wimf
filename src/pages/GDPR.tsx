    ...
    <main className="legal-main">
      ...
      <section>
        <article>
          ...
          <p>
            Ces données nous permettent de vous fournir un service personnalisé
            et d'améliorer le site.
          </p>
          ...
          <p>
            ...
            favoris, notes et commentaires de recettes, ingrédients bannis, date
            de création et mise à jour du compte.
          </p>
          <p>
            Données statistiques : informations collectées via Google Analytics
            pour mesurer et améliorer la fréquentation du site (pages vues,
            durée de visite, type d'appareil, navigateur).
          </p>
          <p>
            Aucune donnée n'est vendue ou cédée à des tiers. Les hébergeurs
            (Vercel, Render, Neon) peuvent traiter certaines données techniques
          ...
          <ul>
            ...
            <li>L'amélioration du fonctionnement et de l'ergonomie du site</li>
            <li>La production de statistiques anonymisées de fréquentation</li>
          </ul>
          ...
          <p>
            Vous pouvez gérer ou refuser les cookies via votre navigateur ou via
            l'outil de désactivation Google Analytics.
          </p>
        </article>
      </section>
