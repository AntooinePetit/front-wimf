  ...
  return (
    <main className="legal-main">
      ...
      <section>
        ...
        <h2>Hébergement</h2>
        <p>
          Le présent site est hébergé par plusieurs prestataires afin d'assurer
        ...
        <p>Les prestataires mentionnés ci-dessus sont situés aux États-Unis.</p>
        <p>
          Ils peuvent être amenés à traiter certaines données techniques et, le
          cas échéant, des données personnelles dans le cadre du fonctionnement
          et de la maintenance du site.
        </p>
        <p>
          Chacun d'eux dispose de politiques de confidentialité et de mesures de
          sécurité conformes aux exigences du Règlement Général sur la
